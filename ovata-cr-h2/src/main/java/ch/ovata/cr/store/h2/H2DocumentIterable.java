/*
 * $Id: H2DocumentIterable.java 2662 2019-09-11 12:27:35Z dani $
 ...
 * @author dani
 */
public class H2DocumentIterable implements StoreDocumentIterable {

    private final Iterable<StoreDocument> iterable;
    
    public H2DocumentIterable( List<StoreDocument> i) {
        this.iterable = i;
    }
