/*
 * $Id: H2Blob.java 2662 2019-09-11 12:27:35Z dani $
 ...
 * @author dani
 */
public class H2Blob implements Binary {

    private final String id;
    private final H2BlobStore store;
    private final String filename;
    private final String contentType;
    private final long length;
    
    public H2Blob( H2BlobStore store, String id, String filename, String contentType, long length) {
        this.id = id;
        this.store = store;
