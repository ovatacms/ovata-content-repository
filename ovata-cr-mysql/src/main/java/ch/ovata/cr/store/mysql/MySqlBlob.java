/*
 * $Id: MySqlBlob.java 690 2017-03-02 22:03:30Z dani $
 ...
 * @author dani
 */
public class MySqlBlob implements Binary {

    private final String id;
    private final MySqlBlobStore store;
    private final String filename;
    private final String contentType;
    private final long length;
    
    public MySqlBlob( MySqlBlobStore store, String id, String filename, String contentType, long length) {
        this.id = id;
        this.store = store;
