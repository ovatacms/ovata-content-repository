/*
 * $Id: MySqlTransaction.java 697 2017-03-06 18:12:59Z dani $
...
public class MySqlTransaction implements Transaction {
    ...
    public MySqlTransaction( SessionImpl session, Connection connection, long revision, String message) {
    ...
    public MySqlTransaction( ResultSet resultSet) throws SQLException {
        this.session = null;
