 ...
 * @author dani
 */
public class PostgresqlBlobStoreFactory implements BlobStoreFactory {

    private final DataSource ds;
    
    public PostgresqlBlobStoreFactory( DataSource ds) {
        this.ds = ds;
    }
    
    @Override
    public BlobStore createBlobStore(String databaseName) {
        return new PostgresqlBlobStore( this.ds, databaseName);
    }
